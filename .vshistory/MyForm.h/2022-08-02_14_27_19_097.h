...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Enter->Location = System::Drawing::Point(75, 28);
			...
			this->curText->Font = (gcnew System::Drawing::Font(L"Segoe UI Symbol", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->curText->Location = System::Drawing::Point(105, 0);
		...
		void addGuess(System::Object^ sender, System::EventArgs^ e) {
			String^ l = sender->ToString();
			currentGuess += l;
