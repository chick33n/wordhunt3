...
#pragma region Windows Form Designer generated code
		...
		void setText(void) {
			...
			for (i = 0; i <= 16; i++) {
				...
				int random = 0;
				bool exists = find(begin(used), end(used), random) != std::end(used);

				do {
					exists = find(begin(used), end(used), random) != std::end(used);
					random = (rand() % 25) + 1;
				}while (exists);
		...
		void change(int b, int rand) {
			...
			char letter = alphabets[2];

			switch (b)

			{
			case 1:
				this->b1->Text = L"hi" + letter;
				break;
			case 2:
				this->b2->Text = L"" + rand;
				break;
			...
			case 9:
				...
				break;
			case 10:
				this->b10->Text = L"" + rand;
				break;
			case 11:
				this->b11->Text = L"" + rand;
				break;
			case 12:
				this->b12->Text = L"" + rand;
				break;
			case 13:
				this->b13->Text = L"" + rand;
				break;
			case 14:
				this->b14->Text = L"" + rand;
				break;
			case 15:
				this->b15->Text = L"" + rand; 
				break;
			case 16:
				this->b16->Text = L"" + rand;
				break;
			default:
				break;
			}
